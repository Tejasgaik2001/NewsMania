...
const News = (props) => {
  ...
  const updatenews = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=0d2f103ebce9478f93947ab18af8d0af&page=${page}`;
  ...
  // makeaprev = async () => {
  //   this.setState({
  //     remianpage: this.state.totalResult + 20,
  //     totalResult: this.state.remianpage,
  //   });
  //   let url = `https://newsapi.org/v2/top-headlines?country=${
  //     props.country
  //   }&category=${
  //     props.category
  //   }&apiKey=0d2f103ebce9478f93947ab18af8d0af&page=${this.state.page - 1}`;
  //   this.setState({
  //     loading: true,
  //   });
  //   let data = await fetch(url);
